        ...
        <div id="contentwrapper" class="contentwrapper elements">
            ...
            <form id="form" method="post" class="stdform stdform2" action="<?php echo $action; ?>">
                <div id="general" class="subcontent">
                    <?php for( $i=1;$i<=count($lbl);$i++ ){ ?>
                    <p>
                        <label><?php echo ucfirst(substr($lbl[$i],4,30)); ?></label>
                        <span class="field">
                            <input type="text" name="val[<?php echo $i; ?>]" value="<?php echo $val[$i];?>" class="mediuminput" autocomplete="off" />
    						<input type="hidden" name="attr[<?php echo $i; ?>]" value="<?php echo $attr[$i];?>" />
                        </span>
                    </p>
                    <?php } ?>
