    <div class="centercontent">
        <div class="pageheader notab">
            ...
            <div id="pos_r">
                <a class="btn btn1 btn_pencil" onclick="openBox('<?php echo $this_modul.'/'.$controller.'/add_'.$method; ?>',825,300);return false;" href="#add">
            ...
            <table class="stdtable stdtablecb" cellspacing="0" cellpadding="0" border="0">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="head1"><?php echo lang('lbl_language'); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="actions">
                                <?php if($akses['edit']==1){ ?>
                                <a title="<?php echo lang('lbl_edit'); ?>" href="#Edit" onclick="openBox('<?php echo $this_modul.'/'.$controller.'/edit_'.$method.'?lang='.$r; ?>',825,500);return false;">
