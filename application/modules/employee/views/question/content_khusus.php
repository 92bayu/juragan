    ...
    <div class="centercontent">
        <div class="pageheader notab">
            ...
            <div id="pos_r">
                ...
                <a class="btn btn1 btn_pencil" onclick="openBox('<?php echo $this_modul . '/' . $controller . '/form_' . $method . '?method=add&id_posisi='.$id_posisi.'&id_tipe='.$id_tipe;if(isset($get_spesifik)) echo $get_spesifik; ?>',825,500);return false;" href="#add">
                <?php }else{ ?>
