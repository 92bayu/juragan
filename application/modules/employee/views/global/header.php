...
<div class="bodywrapper">
            ...
            <div class="userinfodrop">
                <div class="avatar">
                    ...
                    <div class="changetheme">
                    	<?php echo lang('lbl_change_theme'); ?>: <br />
                    	<a class="default"></a>
                        <a class="blueline"></a>
                        <a class="greenline"></a>
                        <a class="contrast"></a>
    ...
    <div class="header">
    	<ul class="headermenu">
        	...
        	<li<?php if($this_modul==$m->target) echo ' class="current"'; ?>><a href="<?php echo $m->target; ?>"><span><img src="userdata/module-icon/<?php echo $m->icon; ?>" /></span><?php if(lang(strtolower(str_replace(' ','_',$m->nama)))) echo lang(strtolower(str_replace(' ','_',$m->nama)));else echo $m->nama; ?></a></li>
            <?php } ?>
        </ul>
