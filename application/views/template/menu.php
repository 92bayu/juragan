        ...
        <ul>
            ...
            <li<?php if($m['id']==$current_id) echo ' class="current"'; ?>>
                ...
                <?php } ?>
                    ...
                    <span><?php if(lang('con_'.$m['target'])) echo lang('con_'.$m['target']); else echo $m['menu']; ?></span>
                </a>
                <?php if(isset($m['submenu'])){ ?>
                ...
                <ul id="<?php echo $m['id']; ?>">
                    ...
                    <li<?php if(isset($this_menu) && $sm['id']==$this_menu) echo ' class="current"' ?>>
                        <a href="<?php echo $this_modul . '/' . $m['target'] . '/' . $sm['target']; ?>">
                            <img src="userdata/menu-icon/<?php echo $sm['icon']; ?>" style="float:left; margin-left:5px; margin-right:5px;" width="20" height="20" /><?php if(lang('con_'.$sm['target'])) echo lang('con_'.$sm['target']); else echo $sm['menu']; ?>
                        </a>
                    </li>
                    <?php } ?>
                </ul>
