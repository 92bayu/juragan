...
<html lang="en">
<head>
<link href="<?php echo base_url(); ?>assets/error/bug.png" rel="shortcut icon" />  
<title>Error</title>
...
#container .bug-icon{
    ...
    height: 256px;
    display: block;
    background-image: url(<?php echo base_url(); ?>assets/error/bug.png);
}
...
<body>
	<div id="container">
        ...
        <a id="report" href="<?php echo base_url(); ?>/send_email?type=general&url=<?php echo "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>" class="myButton">Send Report</a>
