/**
*  Ajax Autocomplete2 for jQuery, version 1.2.4
*  (c) 2013 Tomas Kirda
*
*  Ajax Autocomplete2 for jQuery is freely distributable under the terms of an MIT-style license.
*  For details, see the web site: http://www.devbridge.com/projects/autocomplete2/jquery/
*
*/
...
(function (factory) {
    ...
    Autocomplete2.prototype = {
        ...
        initialize: function () {
            ...
            that.suggestionsContainer = Autocomplete2.utils.createNode('<div class="' + options.containerClass + '" style="position: absolute; display: none;"></div>');
        ...
        onKeyPress: function (e) {
            ...
            switch (e.keyCode) {
                ...
                case keys.RIGHT:
                    ...
                    that.select(that.selectedIndex, e.keyCode === keys.RIGHT);
                    if (e.keyCode === keys.TAB && this.options.tabDisabled === false) {
                        return;
                    }
                    break;
    ...
    $.fn.autocomplete2 = function (options, args) {
